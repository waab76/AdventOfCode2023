...
top_starts = [count_energized({'row':0,'col':i, 'direction':'D'}) for i in range(len(lines[0]))]
left_starts = [count_energized({'row':i,'col':0, 'direction':'R'}) for i in range(len(lines))]
right_starts = [count_energized({'row':i,'col':len(lines[0]) - 1, 'direction':'L'}) for i in range(len(lines))]
bottom_starts = [count_energized({'row':len(lines) - 1,'col':i, 'direction':'U'}) for i in range(len(lines[0]))]

print(max([max(top_starts), max(left_starts), max(right_starts), max(bottom_starts)]))